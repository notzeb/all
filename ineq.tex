...
\begin{comment}
% This is more of a function/derivative problem: can be solved by taking a_i = 1 + tx_i and showing that f(t) = \sqrt[n]{a_1\cdots a_n} has a positive third derivative
